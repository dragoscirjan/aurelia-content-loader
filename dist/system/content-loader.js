...
System.register(['aurelia-templating', 'aurelia-framework', 'uuid-js', './template'], function (_export, _context) {
  ...
  var bindable, containerless, customElement, inlineView, inject, UUID, defaultDivTemplate, defaultSvgTemplate, template, _createClass, _dec, _dec2, _dec3, _class, _desc, _value, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, CSS_CLASS_ANIMATED, SvgContentLoader;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('SvgContentLoader', SvgContentLoader = (_dec = customElement('svg-content-loader'), _dec2 = inlineView(template(defaultDivTemplate, defaultSvgTemplate)), _dec3 = inject(Element), containerless(_class = _dec(_class = _dec2(_class = _dec3(_class = (_class2 = function () {
