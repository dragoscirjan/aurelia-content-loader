...
System.register(["aurelia-templating", "aurelia-framework", "uuid-js", "./template"], function (_export, _context) {
  "use strict";

  var bindable, containerless, customElement, inlineView, inject, UUID, defaultDivTemplate, defaultSvgTemplate, template, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _temp, CSS_CLASS_ANIMATED, SvgContentLoader;
  ...
  return {
    setters: [function (_aureliaTemplating) {
      ...
      UUID = _uuidJs.default;
    }, function (_template) {
      defaultDivTemplate = _template.defaultDivTemplate;
      defaultSvgTemplate = _template.defaultSvgTemplate;
      template = _template.template;
    }],
    execute: function () {
      CSS_CLASS_ANIMATED = 'svg-loader__inner--animated';

      _export("SvgContentLoader", SvgContentLoader = (_dec = customElement('svg-content-loader'), _dec2 = inlineView(template(defaultDivTemplate, defaultSvgTemplate)), _dec3 = inject(Element), containerless(_class = _dec(_class = _dec2(_class = _dec3(_class = (_class2 = (_temp = function () {
      ...
      }(), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "animate", [bindable], {
        configurable: true,
        enumerable: true,
        writable: true,
