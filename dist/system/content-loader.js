...
System.register(['aurelia-templating', 'aurelia-framework', 'uuid-js', './template'], function(_export, _context) {
  ...
  return {
    ...
    execute: function() {
      ...
      _export(
        'SvgContentLoader',
        (SvgContentLoader = ((_dec = customElement('svg-content-loader')),
        (_dec2 = inlineView(template(defaultDivTemplate, defaultSvgTemplate))),
        (_dec3 = inject(Element)),
        containerless(
          (_class =
            _dec(
              (_class =
                    ...
                    _dec3(
                      (_class = ((_class2 = ((_temp = (function() {
                        ...
                        _proto.attached = function attached() {
                          this.element =
                            this.element.nodeType !== 8 ? this.element : this.element.previousElementSibling;
