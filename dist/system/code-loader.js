...
System.register(["aurelia-templating", "./content-loader", "./template"], function (_export, _context) {
  ...
  var bindable, containerless, customElement, inlineView, SvgContentLoader, template, _dec, _dec2, _class, _class2, _descriptor, _temp, divTemplate, svgTemplate, SvgCodeLoader;
  ...
  return {
    ...
    execute: function () {
      divTemplate = '';
      svgTemplate = "<rect repeat.for=\"codeRange of codeRanges()\" x=\"0\" y.bind=\"lineY($index)\" rx.bind=\"cornerRadius\" ry.bind=\"cornerRadius\" width.bind=\"width\" height.bind=\"lineHeight\">\n  <rect repeat.for=\"range of codeRange\" x.bind=\"range.start\" y.bind=\"lineY($parent.$index)\" rx.bind=\"cornerRadius\" ry.bind=\"cornerRadius\" width.bind=\"range.length\" height.bind=\"lineHeight\"/>\n</rect>";

      _export("SvgCodeLoader", SvgCodeLoader = (_dec = customElement('svg-code-loader'), _dec2 = inlineView(template(divTemplate, svgTemplate)), containerless(_class = _dec(_class = _dec2(_class = (_class2 = (_temp = function (_SvgContentLoader) {
      ...
      }(SvgContentLoader), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "maxCodeChunks", [bindable], {
        configurable: true,
        enumerable: true,
        writable: true,
