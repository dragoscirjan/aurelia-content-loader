...
System.register(['aurelia-templating', './content-loader', './template'], function (_export, _context) {
  ...
  var bindable, containerless, customElement, inlineView, SvgContentLoader, template, _dec, _dec2, _class, _desc, _value, _class2, _descriptor, divTemplate, svgTemplate, SvgCodeLoader;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('SvgCodeLoader', SvgCodeLoader = (_dec = customElement('svg-code-loader'), _dec2 = inlineView(template(divTemplate, svgTemplate)), containerless(_class = _dec(_class = _dec2(_class = (_class2 = function (_SvgContentLoader) {
      ...
      }(SvgContentLoader), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, 'maxCodeChunks', [bindable], {
        enumerable: true,
