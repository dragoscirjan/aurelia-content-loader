...
System.register(['aurelia-templating', './content-loader', './template'], function (_export, _context) {
  ...
  var bindable, containerless, customElement, inlineView, SvgContentLoader, template, _createClass, _dec, _dec2, _class, _desc, _value, _class2, _descriptor, _descriptor2, _descriptor3, divTemplate, svgTemplate, SvgListLoader;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('SvgListLoader', SvgListLoader = (_dec = customElement('svg-list-loader'), _dec2 = inlineView(template(divTemplate, svgTemplate)), containerless(_class = _dec(_class = _dec2(_class = (_class2 = function (_SvgContentLoader) {
      ...
      }(SvgContentLoader), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, 'bullets', [bindable], {
        enumerable: true,
