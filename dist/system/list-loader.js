...
System.register(["aurelia-templating", "./content-loader", "./template"], function (_export, _context) {
  ...
  var bindable, containerless, customElement, inlineView, SvgContentLoader, template, _dec, _dec2, _class, _class2, _descriptor, _descriptor2, _descriptor3, _temp, divTemplate, svgTemplate, SvgListLoader;
    ...
    execute: function () {
      ...
      _export("SvgListLoader", SvgListLoader = (_dec = customElement('svg-list-loader'), _dec2 = inlineView(template(divTemplate, svgTemplate)), containerless(_class = _dec(_class = _dec2(_class = (_class2 = (_temp = function (_SvgContentLoader) {
        ...
        function SvgListLoader() {
          ...
          _initializerDefineProperty(_this, "bullets", _descriptor, _assertThisInitialized(_assertThisInitialized(_this)));

          _initializerDefineProperty(_this, "bulletsAsSquares", _descriptor2, _assertThisInitialized(_assertThisInitialized(_this)));

          _initializerDefineProperty(_this, "bulletRadius", _descriptor3, _assertThisInitialized(_assertThisInitialized(_this)));
      ...
      }(SvgContentLoader), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "bullets", [bindable], {
        configurable: true,
        enumerable: true,
        writable: true,
