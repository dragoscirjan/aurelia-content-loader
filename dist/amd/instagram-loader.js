define(["exports", "aurelia-templating", "./content-loader", "./template"], function (_exports, _aureliaTemplating, _contentLoader, _template) {
  ...
  _exports.SvgInstagramLoader = void 0;
  ...
  var SvgInstagramLoader = (_dec = (0, _aureliaTemplating.customElement)('svg-instagram-loader'), _dec2 = (0, _aureliaTemplating.inlineView)((0, _template.template)(divTemplate, svgTemplate)), (0, _aureliaTemplating.containerless)(_class = _dec(_class = _dec2(_class = function (_SvgContentLoader) {
  ...
  _exports.SvgInstagramLoader = SvgInstagramLoader;
});